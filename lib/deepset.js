...
/**
* FUNCTION: betaln( arr, y, path[, sep] )
*	Evaluates the natural logarithm of the beta function for each array element and deep sets the input array.
*
